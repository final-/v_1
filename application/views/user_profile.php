...
<ul>
<li>
<a href="index.php.htm" tppabs="http://pixelcave.com/demo/uadmin/index.php"><i class="icon-fire"></i>Dashboard</a>
</li>
<li>
...
<li>
<a href="page_profile.php.htm" tppabs="http://pixelcave.com/demo/uadmin/page_profile.php" class="active">Profile</a>
</li>
<li>
...
<h3 class="page-header page-header-top">mohamedtemraz <i class="icon-user"></i>  <small>Egypt</small></h3>
<div class="row-fluid">

<div class="span3" style="float:right">

<div class="text-center">
<img src="<?php echo base_url();?>images/image_light_360x270.png" tppabs="http://pixelcave.com/demo/uadmin/img/placeholders/image_light_360x270.png"
 alt="image">
</div>

<ul class="nav nav-tabs nav-stacked" >
<li><a href="javascript:void(0)">صندوق الرسائل <i class="icon-envelope-alt"></i> </a></li>
<li><a href="javascript:void(0)">تعديل حسابي الشخصي <i class="icon-paper-clip"></i> </a></li>
<li><a href="javascript:void(0)">شجره الاعضاء <i class="icon-sitemap"></i></a></li>
</ul>
<ul class="nav nav-tabs nav-stacked">
<li><a href="javascript:void(0)">ايداع رصيد <i class="icon-money"></i></a></li>
<li><a href="javascript:void(0)"> سحب رصيد <i class="icon-money"></i></a></li>
<li><a href="javascript:void(0)">تحويل من رصيد الي شلينات <i class="icon-money"></i></a></li>
</ul></div>
...
<h5 class="page-header-sub"><a href="#">تصميم مواقع مع تقديم الاستضافه</a></h5>
<div class="progress progress-success">
<div class="bar" style="width: 100%"><i class="icon-ok"></i> تمت بنجاح </div>
</div>
<h5 class="page-header-sub"><a href="#">تصميم مواقع مع تقديم الاستضافه</a></h5>
<div class="progress progress-success">
<div class="bar" style="width: 100%"><i class="icon-ok"></i> تمت بنجاح </div>
...
<div class="dash-tile-content">
<div class="dash-tile-content-inner scrollable-tile-2x">
<h5 class="page-header-sub"><a href="javascript:void(0)">تصميم مواقع مع تقديم الاستضافه</a></h5>

<div class="progress progress-success">
<div class="bar" style="width: 0%"><i class="icon-ok"></i> جاري التنفيذ</div>
</div>

<h5 class="page-header-sub"><a href="javascript:void(0)">تصميم مواقع مع تقديم الاستضافه</a></h5>
<div class="progress progress-success">
<div class="bar" style="width: 100%"><i class="icon-ok"></i> جاري التنفيذ</div>
</div>
...
<h5 class="page-header-sub"><a href="javascript:void(0)">تصميم مواقع مع تقديم الاستضافه</a></h5>
<div class="progress progress-success">
<div class="bar" style="width: 1%"><i class="icon-ok"></i> جاري التنفيذ</div>
</div>
