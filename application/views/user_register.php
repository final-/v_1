...
<li>
<a href="page_form_validation.php.htm" tppabs="http://pixelcave.com/demo/uadmin/page_form_validation.php" class="active"><i class="icon-warning-sign"></i>Form Validation</a>
</li>
<li>
...
<input type="text" id="val_email" name="bank_email" value="<?php echo $this->input->post('bank_email') ; ?>" >
<span class="add-on"><i class="icon-envelope"></i></span>
</div>
</div>
</div>
